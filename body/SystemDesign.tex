...
\begin{table}[!htb]
	...
	\caption{Particulate matter sensor specifications. Default conditions of 25±2 DC, 50±10\% relative humidity and 5 V supply voltage apply unless otherwise stated. 'max.' means 'maximum', typ means 'typical', '\% m v.' means '\% of measured value'.}
	\label{tab:prtmat}
\end{table}


\noindent As seen in table~\ref{tab:prtmat} \cite
