...
This study analysed the environmental impact of the taxi industry in South Africa, by surveying a fleet of taxis in Butterworth, they do simple analogue measures such as dust gauges and soil and water analysis. This study concluded that the magnitude of environmental impact caused by taxis is correlated to the size of the taxi rank as well as the size of the population.
...
\end{itemize}
PID sensors uses ultraviolet light to ionise the VOC molecules and measure the electric current. They are typically used for low concentrations.
